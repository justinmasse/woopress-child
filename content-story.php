...
$categories = wp_get_post_terms($postId, 'story_category');
$catsClass = '';
foreach($categories as $category) {
	$catsClass .= ' sort-'.$category->slug;
}

$columns = etheme_get_option('story_columns');
$lightbox = etheme_get_option('story_lightbox');
...
switch($columns) {
	...
	$width = etheme_get_option('story_image_width');
	$height = etheme_get_option('story_image_height');
	$crop = etheme_get_option('story_image_cropping');

?>
<div class="post-grid-item columns-count-<?php echo $columns; ?> <?php echo $span; ?> <?php echo $catsClass; ?>">       
