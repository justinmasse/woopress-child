...
>
    ...
    >
        ...
        if( count( $wishlist_items ) > 0 ) :
                        ...
                        <?php if( $show_stock_status ) : ?>
                            <td class="product-stock-status">
                                ...
                                if( $stock_status == 'out-of-stock' ) {
                                    $stock_status = "Out";
                                    echo '<span class="wishlist-out-of-stock">' . __( 'Not Available Online', 'yit' ) . '</span>';
                                } else {
                                    $stock_status = "In";
            ...
            <tr>
                <td colspan="<?php echo esc_attr( $column_count ) ?>" class="wishlist-empty"><?php _e( 'No products were added to the grocery list', 'yit' ) ?></td>
            </tr>
        <?php
        endif;
